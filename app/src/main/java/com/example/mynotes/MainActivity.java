...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private void updateRecycler(List<Notes> notes) {
        ...
        notesListAdapter = new NotesListAdapter(MainActivity.this,notes,notesClickLListener);
        recyclerView.setAdapter(notesListAdapter);

    }
    private final NotesClickLListener notesClickLListener = new NotesClickLListener() {
        @Override
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.delete:
                ...
                notesListAdapter.notifyDataSetChanged();
                Toast.makeText(MainActivity.this, R.string.Noteremoved, Toast.LENGTH_SHORT).show();
                return true;
            default:
                return false;
