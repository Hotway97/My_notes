...
import com.example.mynotes.NotesClickLListener;
...
NotesClickLListener listener;

    public NotesListAdapter(Context context, List<Notes> list, NotesClickLListener listener) {
